...
export const BusinessBasicsPage = () => {
  return (
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      >
        <h1 className="mb-4">Business Basics</h1>
        <p className="text-lg text-gray-600">
          Learn the fundamental concepts and principles of starting a business
        </p>
      </motion.div>
      ...
      >
        <img src="https://images.unsplash.com/photo-1487017159836-4e23ece2e4cf?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=&ixlib=rb-4.0.3&q=80&w=1080" 
          alt="Business education concept" 
          className="w-full h-64 object-cover rounded-xl mb-8" 
          data-image-request="business education concept with Tamil Nadu students learning in a modern classroom with business charts and diagrams"
        />
      </motion.div>
